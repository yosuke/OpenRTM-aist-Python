...
class Properties:
	...
	def setProperty(self, key, value=None):
		...
		\param key(string) プロパティリストに配置されるキー
		\param value(string) key に対応する値 
