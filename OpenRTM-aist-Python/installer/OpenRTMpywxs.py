...
data = [
    ...
    ("OpenRTM_aist/examples/SimpleService/_GlobalIDL",      "*.py"),
    ("OpenRTM_aist/examples/SimpleService/_GlobalIDL__POA", "*.py"),
    ...
    ("OpenRTM_aist24",                                      "*.py"),
    ("OpenRTM_aist24/rtc-template",                         "*.py"),
    ("OpenRTM_aist24/RTM_IDL",                              "*.py *.idl *.pth"),
    ("OpenRTM_aist24/root",                                 "*.pth"),
    ("OpenRTM_aist25",                                      "*.py"),
    ("OpenRTM_aist25/rtc-template",                         "*.py"),
