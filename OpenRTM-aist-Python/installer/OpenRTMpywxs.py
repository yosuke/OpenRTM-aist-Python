...
data = [
    ...
    ("OpenRTM_aist24",                            "*.py"),
    ("OpenRTM_aist24/utils/rtcd",                 "rtcd.py"),
    ("OpenRTM_aist24/utils/rtcprof",              "rtcprof.py"),
    ...
    ("OpenRTM_aist25",                            "*.py"),
    ("OpenRTM_aist25/utils/rtcd",                 "rtcd.py"),
    ("OpenRTM_aist25/utils/rtcprof",              "rtcprof.py"),
    ...
    ("OpenRTM_aist26",                            "*.py"),
    ("OpenRTM_aist26/utils/rtcd",                 "rtcd.py"),
    ("OpenRTM_aist26/utils/rtcprof",              "rtcprof.py"),
