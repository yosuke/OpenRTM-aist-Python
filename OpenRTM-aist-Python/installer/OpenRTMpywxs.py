...
data = [
    ...
    ("OpenRTM_aist24",                            "*.py"),
    ("OpenRTM_aist24/utils/rtcd",                 "rtcd.py rtcd_python.exe rtcd.conf"),
    ...
    ("OpenRTM_aist25",                            "*.py"),
    ("OpenRTM_aist25/utils/rtcd",                 "rtcd.py rtcd_python.exe rtcd.conf"),
    ...
    ("OpenRTM_aist26",                            "*.py"),
    ("OpenRTM_aist26/utils/rtcd",                 "rtcd.py rtcd_python.exe rtcd.conf"),
