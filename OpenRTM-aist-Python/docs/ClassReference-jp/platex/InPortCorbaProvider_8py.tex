\section{In\-Port\-Corba\-Provider.py}
\label{InPortCorbaProvider_8py}\index{InPortCorbaProvider.py@{InPortCorbaProvider.py}}
...
\begin{CompactList}\small\item\em In\-Port\-Corba\-Provider ÉNÉâÉX. \item\end{CompactList}\end{CompactItemize}
