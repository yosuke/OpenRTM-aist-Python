...
class ConsumerMock(OpenRTM_aist.InPortCorbaCdrConsumer):
	def __init__(self):
		self._buffer = OpenRTM_aist.CdrRingBuffer()
...
class TestPublisherPeriodic(unittest.TestCase):
	...
	def test_convertReturn(self):
		_pn = PublisherPeriodic()
		self.assertEqual(_pn.convertReturn(OpenRTM_aist.BufferStatus.BUFFER_OK),
				 OpenRTM_aist.DataPortStatus.PORT_OK)
		self.assertEqual(_pn.convertReturn(OpenRTM_aist.BufferStatus.BUFFER_EMPTY),
				 OpenRTM_aist.DataPortStatus.BUFFER_EMPTY)
		self.assertEqual(_pn.convertReturn(OpenRTM_aist.BufferStatus.TIMEOUT),
				 OpenRTM_aist.DataPortStatus.BUFFER_TIMEOUT)
		self.assertEqual(_pn.convertReturn(OpenRTM_aist.BufferStatus.PRECONDITION_NOT_MET),
				 OpenRTM_aist.DataPortStatus.PRECONDITION_NOT_MET)
		self.assertEqual(_pn.convertReturn(100),
