...
class OutPortObj(OpenRTM_aist.DataFlowComponentBase):
	def __init__(self):
		...
		self.registerOutPort("out",OpenRTM_aist.OutPort("out", RTC.TimedLong(RTC.Time(0,0),0)))


class InPortObj(OpenRTM_aist.DataFlowComponentBase):
	def __init__(self):
		OpenRTM_aist.DataFlowComponentBase.__init__(self, OpenRTM_aist.Manager.instance())
		self.registerInPort("in",OpenRTM_aist.InPort("in", RTC.TimedLong(RTC.Time(0,0),0)))
