...
class ConnectorMock:
	...
	def profile(self):
		return OpenRTM_aist.ConnectorBase.Profile(self._name,self._id,self._ports,self._properties)
...
class TestOutPortBase(unittest.TestCase):
	...
	def test_publishInterfaceProfiles(self):
		self.assertEqual(self._opb.publishInterfaceProfiles(None),True)
		return
