...
class TestConfiguration_impl(unittest.TestCase):
	def setUp(self):
		...
		ca   = OpenRTM.ConfigAdmin(prop.getNode("conf"))
	...
	def test_set_service_profile(self):
		sprof = SDOPackage.ServiceProfile("test","MyService",[],ServiceProf())
		self._sdoconf.set_service_profile(sprof)
		...
		self.assertRaises(SDOPackage.InvalidParameter, self._sdoconf.set_service_profile, None )
	...
	def test_get_configuration_parameter(self):
		self.assertRaises(SDOPackage.InvalidParameter, self._sdoconf.set_configuration_parameter, None, "aaa" )
		self.assertRaises(SDOPackage.InvalidParameter, self._sdoconf.set_configuration_parameter, "bbb", None )
	...
	def test_set_configuration_set_values(self):
		self._sdoconf.set_configuration_set_values("default2", SDOPackage.ConfigurationSet("default2","",[]))

		self.assertRaises(SDOPackage.InvalidParameter, self._sdoconf.set_configuration_set_values, None, None )
